...
return(
          ...
          {isShowBody && <div id="aside" className="expand">
            ...
            <div className="items">
                ...
                <Item label="Members" iconName= {< MdPersonOutline size={14}/>} iconName2={<GoPlusSmall/>} id2="plus"/>
                <Item label="Settings" iconName= {< MdSettings size={14}/>} iconName2={<MdKeyboardArrowDown/>} id2="d_arrow"/>
                <br/>
                <p id="topic"><b>Workspace views</b></p>
                <Item label="Table" iconName= {< BiTable size={14}/>} />
                <Item label="Calendar" iconName= {< BiCalendarAlt size={14}/>} /><br/>
                <div id="topic"><span>Your Boards</span> <span id="title_icon"><GoPlusSmall size={20}/></span></div><br/>
                <Item label="G&T" iconName= {<img id="pic" src={require("../../images/bg.jpeg")} alt=""  />} iconName2={<MdMoreHoriz size={15}/>} id2="more1" iconName3={<MdStarOutline size={14} />} id3="important"/><br/>
            </div>
